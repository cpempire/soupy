...
class CostFunctionalQuadraticMultiPDE(CostFunctional):
    ...
    def __init__(self, parameter, Vh, pde, qoi, prior, penalization, tol=1e-9):
        ...
        self.rhs_fwd, self.rhs_adj, self.rhs_adj2, self.rhs_adj3 = [None]*self.N_pde, [None]*self.N_pde, [None]*self.N_pde, [None]*self.N_pde
    ...
    def QuadraticSampling(self, sample, savedata=False, i=0, type='random', n_pde=0): # to add N_pde
        ...
        Q_mean = self.qoi[n_pde].eval(x) # Q(x(m_i))
    ...
    def solveAdjFwd(self):
        ...
        for n_pde in range(self.N_pde):
            ...
            self.qoi[n_pde].grad_state(self.x[n_pde], ystarrhsqoi)
        ...
        for n_pde in range(self.N_pde):
            ...
            for i in range(self.N_tr):
                ...
                dyzr, dxzr, dyxzr, dymzr, dxyzr, dxxzr, dxmzr, dmmzr, dmyzr, dmxzr = \
                    self.pde[n_pde].gradientControl(self.x_all[n_pde],self.xstar[n_pde],self.ystar[n_pde],xhat,xhatstar,mhat,mhatstar,yhat,yhatstar)
